        ...
        <div class="sidebar-scrollarea">
            ...
            <div class="side-nav">
                <ul class="nav">
                    ...
                    <li>
                        <a href="#" class="{{ Request::is('cms/prizes') || Request::is('cms/lottery/configs') ? 'expand active-state' : '' }}"><i class="l-basic-folder"></i> <span class="txt">奖品配置</span></a>
                        <ul class="sub {{ Request::is('cms/prizes') || Request::is('cms/lottery/configs') ? ' show' : '' }}">
